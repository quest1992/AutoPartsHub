...
export class ShopsController {
  ...
  @Get()
  @RequirePermissions(Permission.SHOPS_VIEW)
  @ApiOperation({ summary: 'Список магазинов' })
  @ApiQuery({ name: 'includeInactive', required: false, type: Boolean })
  @ApiOkResponse()
  @ApiUnauthorizedResponse()
  @ApiForbiddenResponse()
  findAll(@Query() query: ListShopsQueryDto) {
    return this.shopsService.findAll(query.includeInactive);
  }
  @Post()
  @RequirePermissions(Permission.SHOPS_MANAGE)
  ...
  @Post(':id/deactivate')
  @RequirePermissions(Permission.SHOPS_MANAGE)
  @ApiOperation({ summary: 'Деактивировать магазин' })
  @ApiOkResponse()
  @ApiUnauthorizedResponse()
  @ApiForbiddenResponse()
  @ApiNotFoundResponse()
