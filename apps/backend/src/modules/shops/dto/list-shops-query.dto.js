...
exports.ListShopsQueryDto = void 0;
var class_transformer_1 = require("class-transformer");
var class_validator_1 = require("class-validator");
var ListShopsQueryDto = function () {
    var _a;
    var _includeInactive_decorators;
    var _includeInactive_initializers = [];
    var _includeInactive_extraInitializers = [];
    return _a = /** @class */ (function () {
            function ListShopsQueryDto() {
                this.includeInactive = __runInitializers(this, _includeInactive_initializers, void 0);
                __runInitializers(this, _includeInactive_extraInitializers);
            }
            return ListShopsQueryDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _includeInactive_decorators = [(0, class_validator_1.IsOptional)(), (0, class_transformer_1.Transform)(function (_b) {
                    var value = _b.value;
...
exports.ListShopsQueryDto = ListShopsQueryDto;
