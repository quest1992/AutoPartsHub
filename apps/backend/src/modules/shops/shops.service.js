...
var ShopsService = function () {
    ...
    var ShopsService = _classThis = /** @class */ (function () {
        function ShopsService_1(prisma) {
            this.prisma = prisma;
        }
        ShopsService_1.prototype.create = function (dto) {
            return this.prisma.shop.create({ data: dto });
        };
        ShopsService_1.prototype.findAll = function (includeInactive) {
        ...
        ShopsService_1.prototype.findOne = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var shop;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.prisma.shop.findUnique({ where: { id: id } })];
                        case 1:
                            shop = _a.sent();
                            if (!shop)
        ...
        ShopsService_1.prototype.update = function (id, dto) {
            return __awaiter(this, void 0, void 0, function () {
                var error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, this.prisma.shop.update({ where: { id: id }, data: dto })];
        ...
        ShopsService_1.prototype.deactivate = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                var shop, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, this.prisma.shop.update({
                                    where: { id: id },
                                    data: { isActive: false },
                                })];
                        case 3: return [2 /*return*/, _a.sent()];
