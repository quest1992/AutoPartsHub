    ...
    var CategoriesService = _classThis = /** @class */ (function () {
        ...
        CategoriesService_1.prototype.create = function (createCategoryDto) {
            return __awaiter(this, void 0, void 0, function () {
                var parentCategory, categoryWithSameSlug;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!createCategoryDto.parentId) return [3 /*break*/, 2];
                        ...
                        case 1:
                            ...
                            if (!parentCategory.isActive) {
                                throw new common_1.BadRequestException('Нельзя добавить подкатегорию в отключённую категорию');
                            }
                            _a.label = 2;
                        case 2: return [4 /*yield*/, this.prisma.category.findUnique({
                                where: {
                                    slug: createCategoryDto.slug,
                                },
                            })];
                        case 3:
                            categoryWithSameSlug = _a.sent();
                            if (categoryWithSameSlug) {
                                throw new common_1.BadRequestException('Категория с таким slug уже существует');
                            }
