...
var create_part_category_dto_1 = require("./create-part-category.dto");
var UpdatePartCategoryDto = function () {
    var _a;
    var _classSuper = (0, swagger_1.PartialType)((0, swagger_1.OmitType)(create_part_category_dto_1.CreatePartCategoryDto, ['parentId']));
    var _parentId_decorators;
    var _parentId_initializers = [];
    var _parentId_extraInitializers = [];
    return _a = /** @class */ (function (_super) {
            __extends(UpdatePartCategoryDto, _super);
            function UpdatePartCategoryDto() {
                var _this = _super !== null && _super.apply(this, arguments) || this;
                _this.parentId = __runInitializers(_this, _parentId_initializers, void 0);
                __runInitializers(_this, _parentId_extraInitializers);
                return _this;
            }
            return UpdatePartCategoryDto;
        }(_classSuper)),
        (function () {
            var _b;
