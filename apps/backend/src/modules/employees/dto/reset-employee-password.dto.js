...
exports.ResetEmployeePasswordDto = void 0;
var class_validator_1 = require("class-validator");
var ResetEmployeePasswordDto = function () {
    var _a;
    var _temporaryPassword_decorators;
    var _temporaryPassword_initializers = [];
    var _temporaryPassword_extraInitializers = [];
    return _a = /** @class */ (function () {
            function ResetEmployeePasswordDto() {
                this.temporaryPassword = __runInitializers(this, _temporaryPassword_initializers, void 0);
                __runInitializers(this, _temporaryPassword_extraInitializers);
            }
            return ResetEmployeePasswordDto;
        }()),
        (function () {
...
exports.ResetEmployeePasswordDto = ResetEmployeePasswordDto;
