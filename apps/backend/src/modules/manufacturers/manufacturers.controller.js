...
var ManufacturersController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Производители автомобилей'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard, permissions_guard_1.PermissionsGuard), (0, roles_decorator_1.Roles)(client_1.UserRole.SUPER_ADMIN, client_1.UserRole.SHOP_ADMIN, client_1.UserRole.MANAGER, client_1.UserRole.SELLER, client_1.UserRole.VIEWER), (0, common_1.Controller)('manufacturers')];
    ...
    var ManufacturersController = _classThis = /** @class */ (function () {
        ...
        ManufacturersController_1.prototype.create = function (createManufacturerDto) {
        ...
        ManufacturersController_1.prototype.findOne = function (id) {
    ...
    (function () {
        ...
        _create_decorators = [(0, common_1.Post)(), (0, swagger_1.ApiOperation)({
            ...
            }), (0, roles_decorator_1.Roles)(client_1.UserRole.SUPER_ADMIN), (0, require_permissions_decorator_1.RequirePermissions)(permission_enum_1.Permission.CATALOG_MANAGE)];
        _findAll_decorators = [(0, common_1.Get)(), (0, require_permissions_decorator_1.RequirePermissions)(permission_enum_1.Permission.CATALOG_VIEW), (0, swagger_1.ApiOperation)({
                summary: 'Получить список производителей',
            }), (0, swagger_1.ApiOkResponse)({
                description: 'Список производителей получен',
            })];
        _findOne_decorators = [(0, common_1.Get)(':id'), (0, require_permissions_decorator_1.RequirePermissions)(permission_enum_1.Permission.CATALOG_VIEW), (0, swagger_1.ApiOperation)({
