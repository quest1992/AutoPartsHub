    ...
    var UsersService = _classThis = /** @class */ (function () {
        ...
        UsersService_1.prototype.create = function (createUserDto) {
            return __awaiter(this, void 0, void 0, function () {
                var existingUser, shop, passwordHash, user;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 1:
                            ...
                            if (existingUser) {
                                throw new common_1.BadRequestException('Пользователь с таким телефоном или email уже существует');
                            }
                            if (!createUserDto.shopId) return [3 /*break*/, 3];
                        ...
                        case 2:
                            ...
                            _b.label = 3;
                        case 3: return [4 /*yield*/, bcrypt.hash(createUserDto.password, 12)];
                        case 4:
                            ...
                            return [4 /*yield*/, this.prisma.user.create({
                                    data: {
                                        ...
                                        role: (_a = createUserDto.role) !== null && _a !== void 0 ? _a : client_1.UserRole.SELLER,
        ...
        UsersService_1.prototype.findAuthUserById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.findUnique({
                            where: { id: id },
        ...
        UsersService_1.prototype.findCurrentUserById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.user.findUnique({
                            where: { id: id },
